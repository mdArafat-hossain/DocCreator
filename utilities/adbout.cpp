...
void admin(int logchoice)
{
    ...
    {
        string username, pass, email, company_name, address, number,status;
        ...
        while(getline(file, username, '|') && getline(file, pass, '|') && getline(file, email, '|') && getline(file, company_name, '|') && getline(file, address, '|') && getline(file, number, '|') && getline(file, status, '|'))
        {
